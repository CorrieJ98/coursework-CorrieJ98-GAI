/*
 Copied Node.cs from Hamids Games AI pathfinding lesson
 */
...
public class Node : IComparable<Node>
{
    ...
    /// <summary>This its used for debugging/visual display and would not be used in final versions of this class</summary>
