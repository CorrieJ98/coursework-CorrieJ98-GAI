...
public sealed class GameData : MonoBehaviour
{
	...
	/// <summary>
	/// If you want to create your own classes that derive from SteeringAgent then use this to assign which ally
	/// agents will have which SteeringAgent types
	/// </summary>
	/// <param name="agentIndexToAgentType">The int keys represent the agent creation order and Type is what class to create</param>
	public void CreateAllyAgents(Dictionary<int, Type> agentIndexToAgentType)
	{
		agentsManager.CreateAllyAgents(agentIndexToAgentType);
	}
