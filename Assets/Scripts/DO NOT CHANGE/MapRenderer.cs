...
public class MapRenderer : MonoBehaviour
{
	...
	private static readonly Color ColourWater = Color.blue;
	private static readonly Color ColourMud = new Color(130f / 255f, 60f / 255f, 10f / 255f);
	private static readonly Color ColourGrass = new Color(0f, 0.8f, 0f);
	private static readonly Color ColourTrees = new Color(0f, 0.4f, 0f);
	private static readonly Color ColourSnow = Color.white;
	private static readonly Color ColourUnknown = Color.magenta;
	private static readonly Color ColourInvalid = Color.black;
